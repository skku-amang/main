...
| 라벨 | 액션 |
| --- | --- |
| 🔥 | `gh issue create --repo skku-amang/main --label "kind: bug,priority: critical,from: sentry"(또는 from: user-feedback) --title "..." --body "..."` — body는 [issue-template.md](issue-template.md) 적용 |
